...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_exit.setGeometry(QtCore.QRect(150, 260, 90, 28))
        self.btn_exit.setObjectName(_fromUtf8("btn_exit"))
        self.txt_passwd = QtGui.QLineEdit(Form)
        self.txt_passwd.setGeometry(QtCore.QRect(110, 150, 191, 32))
        ...
        self.label.setGeometry(QtCore.QRect(110, 70, 62, 20))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(110, 130, 91, 20))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.btn_login = QtGui.QPushButton(Form)
        self.btn_login.setGeometry(QtCore.QRect(150, 200, 90, 28))
        self.btn_login.setObjectName(_fromUtf8("btn_login"))
        self.txt_user = QtGui.QLineEdit(Form)
        self.txt_user.setGeometry(QtCore.QRect(110, 90, 191, 32))
        self.txt_user.setObjectName(_fromUtf8("txt_user"))
        self.btn_new_user = QtGui.QPushButton(Form)
        self.btn_new_user.setGeometry(QtCore.QRect(150, 230, 90, 28))
        self.btn_new_user.setObjectName(_fromUtf8("btn_new_user"))
        self.lbl_error = QtGui.QLabel(Form)
        self.lbl_error.setGeometry(QtCore.QRect(110, 180, 191, 20))
